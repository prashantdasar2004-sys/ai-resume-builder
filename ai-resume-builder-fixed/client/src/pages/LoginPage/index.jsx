    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="text-center text-muted mt-lg">
          ...
          <button onClick={() => setIsRegister(!isRegister)} className="text-purple font-medium"
      ...
      <div className="auth-trust-line">
        <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><HiShieldCheck /> Secure login</span>
        <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><HiSparkles /> AI-powered</span>
        <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><HiCheck /> Free to start</span>
      </div>
    </div>
  );
}
