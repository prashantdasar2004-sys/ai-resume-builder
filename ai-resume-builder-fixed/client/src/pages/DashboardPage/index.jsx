...
function DashboardPage() {
  ...
  // atsScore is stored as a plain Number in DB (0-100)
  // so we check > 0, NOT resume.atsScore?.overall
        ...
        {!isLoading && resumes.length === 0 && (
          <div className="empty-state">
            ...
            <p className="text-muted mb-lg">
              Head to the Home page to create your first AI-powered resume
            </p>
          </div>
        )}
        ...
        {!isLoading && resumes.length > 0 && (
          <div className="grid-auto">
            {resumes.map((resume) => {
              ...
              // atsScore is a plain number from DB e.g. 72
              const score = typeof resume.atsScore === 'number' ? resume.atsScore : 0;
                  ...
                  <div className="resume-card-body">
                    <div className="flex-between mb-sm">
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {resume.targetRole && (
                          <p className="text-xs truncate" style={{ marginTop: '2px' }}>
                            {resume.targetRole}
                          </p>
                        )}
                      </div>
                    ...
                    {/* ATS Score — score is a plain number, not an object */}
                    {score > 0 && (
